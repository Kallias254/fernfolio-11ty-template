...
module.exports = function (eleventyConfig) {
  ...
  // Add new resolveImagePath filter
  eleventyConfig.addFilter("resolveImagePath", function (imagePath) {
    if (!imagePath) return "";
    // Handle both src/assets/img and /src/assets/img paths
    return imagePath.replace(/^\/?(src\/)?assets\/img\//, "/assets/img/");
  });
  ...
  // Updated passthrough copy for assets/img
